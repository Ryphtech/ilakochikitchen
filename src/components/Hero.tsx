    ...
    return (
        <section className="relative w-full h-dvh mt-[-56px] md:mt-[-80px] pt-[56px] md:pt-[80px] flex flex-col items-center justify-center overflow-hidden px-6">
            ...
            <div className="relative z-10 flex flex-col items-center text-center max-w-4xl mx-auto space-y-8">
                ...
                {/* Mobile-only Social Media Icons — Glassy Style */}
                <div className="flex md:hidden items-center gap-4 -mt-4 pointer-events-auto relative z-40 opacity-0 animate-[fade-in_1.5s_ease-out_3.5s_forwards]">
                    {/* Instagram */}
                    <a
                        href="https://www.instagram.com/ilakochi"
                        target="_blank"
                        rel="noopener noreferrer"
                        aria-label="Instagram"
                        className="w-11 h-11 rounded-full backdrop-blur-xl bg-white/15 border border-white/25 flex items-center justify-center shadow-lg hover:bg-white/25 hover:scale-110 transition-all duration-300"
                    >
                    ...
                    {/* JustDial */}
                    <a
                        href="https://www.justdial.com/ilakochi"
                        target="_blank"
                        rel="noopener noreferrer"
                        aria-label="JustDial"
                        className="w-11 h-11 rounded-full backdrop-blur-xl bg-white/15 border border-white/25 flex items-center justify-center shadow-lg hover:bg-white/25 hover:scale-110 transition-all duration-300"
